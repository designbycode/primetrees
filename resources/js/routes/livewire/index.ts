 ...
 * @route '/livewire-d57a713c/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-d57a713c/upload-file',
 ...
 * @route '/livewire-d57a713c/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-d57a713c/preview-file/{filename}',
