...
export default function AppFooter() {
    return (
        <footer className="bg-card border-t border-border py-8 px-6 text-center text-xs text-muted-foreground mt-auto w-full transition-colors duration-300">
            <Wrapper className="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-2 text-left">
                    ...
                    <span className="font-mono tracking-tight">
                        &copy; {new Date().getFullYear()} Primetrees. All rights
                        reserved.
                    </span>
                </div>
