 ...
 * @route '/livewire-d57a713c/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-d57a713c/livewire.js',
 ...
 * @route '/livewire-d57a713c/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-d57a713c/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-d57a713c/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-d57a713c/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
