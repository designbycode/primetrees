...
export default function Welcome({ laravelVersion, phpVersion }: Props) {
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-20 flex flex-col items-center text-center animate-fade-in">
...
Welcome.layout = (page: React.ReactNode) => <AppLayout title="Welcome">{page}</AppLayout>;
