    ...
    return (
        <Wrapper>
            <div className="mb-10 text-left w-full pt-4">
                ...
                <p className="text-base sm:text-lg text-foreground/60 mt-5 max-w-2xl leading-normal font-sans">
                    Browse our certified botanical species directory, select
                    specimens to build a customized reforestation map, and
                    simulate carbon/oxygen indices directly.
                </p>
            </div>
        </Wrapper>
    );
