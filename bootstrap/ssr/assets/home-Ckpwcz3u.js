...
function Hero() {
	return /* @__PURE__ */ jsx(Wrapper, { children: /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("p", {
				className: "text-base sm:text-lg text-foreground/60 mt-5 max-w-2xl leading-normal font-sans",
				children: "Browse our certified botanical species directory, select specimens to build a customized reforestation map, and simulate carbon/oxygen indices directly."
			})
		]
	}) });
}
...
function Home() {
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Hero, {}), /* @__PURE__ */ jsx(Wrapper, {
		className: "py-6 ",
		children: /* @__PURE__ */ jsx(GridFeatureSpotlight, {})
	})] });
}
